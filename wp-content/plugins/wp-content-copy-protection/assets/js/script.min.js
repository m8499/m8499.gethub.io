...
}, window.addEventListener("keyup", wpccpDisableCtrlActions, !1), window.addEventListener("keydown", wpccpDisableCtrlActions, !1), window.addEventListener("keyup", wpccpDisableKeys, !1), window.addEventListener("keydown", wpccpDisableKeys, !1), window.addEventListener("keyup", wpccpDisablePrintScreen, !1);